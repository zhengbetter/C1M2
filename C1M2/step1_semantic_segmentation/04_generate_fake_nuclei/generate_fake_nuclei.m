function [nuclei, nucle_100] = generate_fake_nuclei(cell_semantic, nuclei_r, nuclei_thr, pixdim)
...
for i=1:1:n_c
    fprintf(strcat("generate fake nuclei for %d connected component \n"), i);
    tmp_cell = cell_mat==i;
    ...
    tmp_nucle = erode_cell(tmp_nucle, tmp_cell, nuclei_thr, nuclei_r, pixdim);
