...
root_path = '/data2/zhenghao/cell_segment/dataset/standard/upload/f480/';
...
for i_stack = [1, 2]
        ...
        cell_semantic = cell_semantic_segment_two_channel(cat(4, nucleus_ori, cell_eq), 25,55, pixdim, 6000);
        ...
        single_volume = quantile(table2array(regionprops3(cell_one, 'Volume')), 0.5); % auto setting
        ...
        mat2image(strcat(root_path,'c1m2/',num2str(i_stack), '/instance/'), merge, [],0);
